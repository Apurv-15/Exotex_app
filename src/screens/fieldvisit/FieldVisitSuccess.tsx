    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <Animated.Text style={[styles.successTitle, { opacity: fadeAnim }]}>Visit Recorded!</Animated.Text>
                <Animated.Text style={[styles.successSubtitle, { opacity: fadeAnim }]}>
                    The field visit report for <Text style={{ fontWeight: 'bold', color: '#1B4332' }}>{formData.clientCompanyName || formData.contactPersonName}</Text> has been saved successfully.
                </Animated.Text>
